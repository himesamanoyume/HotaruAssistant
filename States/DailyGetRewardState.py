...
class DailyGetRewardState(object):
    ...
    def OnBegin(self):
        ...
        if screenMgr.FindElement("./assets/images/menu/pass_reward.png", "image", 0.95):
            ...
            DailyGetRewardState.GetPassReward()
    ...
    def GetDispatchReward(uid):
        ...
        DailyGetRewardState.PerformDispatches()
    ...
    def PerformDispatches():
        for i in range(4):
            ...
            if not DailyGetRewardState.PerformDispatchAndCheck(crop=(298.0 / 1920, 153.0 / 1080, 1094.0 / 1920, 122.0 / 1080)):
                return

            if not DailyGetRewardState.PerformDispatchAndCheck(crop=(660 / 1920, 280 / 1080, 170 / 1920, 600 / 1080)):
                return
    ...
    def PerformDispatchAndCheck(crop):
        if not DailyGetRewardState.ClickCompleteDispatch(crop):
