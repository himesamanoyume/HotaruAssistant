...
class ConfigKey:
    ...
    ORNAMENT_EXTRACTION_TEAM = 'ornament_extraction_team'
    UNIVERSE_FATE = 'universe_fate'
    UNIVERSE_NUMBER = 'universe_number'
    UNIVERSE_DIFFICULTY = 'universe_difficulty'
    ORNAMENT_EXTRACTION_DIFFICULTY = 'ornament_extraction_difficulty'
    CYLAX_GOLDEN = '拟造花萼（金）'
    ...
    RELICS_SALVAGE_ENABLE = 'relics_salvage_enable'
    RELICS_SALVAGE_5STAR_ENABLE = 'relics_salvage_5star_enable'
    RELICS_SALVAGE_4STAR_ENABLE = 'relics_salvage_4star_enable'
    RELICS_SALVAGE_5STAR_TO_EXP = 'relics_salvage_5star_to_exp'
    RELICS_THRESHOLD_COUNT = 'relics_threshold_count'
    STORE_ENABLE = 'store_enable'
    STORE_PRODUCT_ENABLE = 'store_product_enable'
    STORE_SOLDOUT_TIMESTAMP = 'store_soldout_timestamp'
    STORE_PRODUCT_PRIORITY = 'store_product_priority'
