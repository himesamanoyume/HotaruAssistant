...
class WebModule:
    ...
    def ConfigSetting(uid):
        ...
        return render_template(
            ...
            uid=uid, 
            loginList=WebModule.InitLoginList(),
            instance_names = configMgr.mConfig[configMgr.mKey.INSTANCE_NAMES],
            instance_type = configMgr.mConfig[configMgr.mKey.INSTANCE_TYPE],
            universe_team = configMgr.mConfig[configMgr.mKey.UNIVERSE_TEAM],
            universe_fate = configMgr.mConfig[configMgr.mKey.UNIVERSE_FATE],
            configMgr=configMgr,
            updateList=notifyMgr.CreateUpdateContent(dataMgr),
            annList=annList,
            dataMgr=dataMgr, 
