...
class WebModule:
    ...
    def ConfigSetting(uid):
        ...
        return render_template(
            ...
            uid=uid, 
            loginList=WebModule.InitLoginList(),
            instance_names = configMgr.mConfig[configMgr.mKey.INSTANCE_NAMES][uid],
            instance_type = configMgr.mConfig[configMgr.mKey.INSTANCE_TYPE][uid],
            universe_team = configMgr.mConfig[configMgr.mKey.UNIVERSE_TEAM][uid],
            universe_fate = configMgr.mConfig[configMgr.mKey.UNIVERSE_FATE][uid],
            configMgr=configMgr,
            updateList=notifyMgr.CreateUpdateContent(dataMgr),
            annList=annList,
            dataMgr=dataMgr, 
