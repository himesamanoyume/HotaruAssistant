...
class FastestMirror:
    ...
    def get_github_api_mirror(user, repo, file, timeout=5):
        mirror_urls = [
            ...
            f"https://cdn.jsdelivr.net/gh/himesamanoyume/March7thAssistantPrivate@release/{file}",
            f"https://ghproxy.com/https://raw.githubusercontent.com/himesamanoyume/March7thAssistantPrivate/release/{file}",
            f"https://github.moeyy.xyz/https://raw.githubusercontent.com/himesamanoyume/March7thAssistantPrivate/release/{file}",
        ]
        return FastestMirror.find_fastest_mirror(mirror_urls, timeout)
