...
$('#nav-select-uid').on('change', function(){
    var uid = $('#nav-select-uid').val()
...
function daily_submitChange(){
    if(confirm("确定要保存吗?")){
        ...
        $('input[name="daily_tasks"]').each(function(){
            daily_tasks_arr.push($(this).prop('checked'))
        })
        
        var uid = $('.body').attr('data-rt')

        var json={
            "daily_tasks_arr":daily_tasks_arr,
        }
...
function config_submitChange(){
    if(confirm("确定要保存吗?")){
        ...
        var instance_name4 = $('select[name="instance_name4"]').val()
        var instance_name5 = $('select[name="instance_name5"]').val()
        var echo_of_war_enable = $('input[name="echo_of_war_enable"]').prop('checked')
        ...
        var universe_team0 = $('select[name="universe_team0"]').val()
        ...
        var json={
            ...
            "instance_name4":instance_name4,
            "instance_name5":instance_name5,
