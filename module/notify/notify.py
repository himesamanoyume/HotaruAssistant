...
class Notify:
    ...
    def _send_notification_by_smtp(self, title, content):
        ...
        # _content.update({'uid':'100593155'})
        # _content.update({'date':'2023-10-29'})
        # _content.update({'full_power_time':'timestamp'})
