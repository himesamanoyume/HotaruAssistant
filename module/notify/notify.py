...
class Notify:
    ...
    def _send_notification_by_smtp(self, title, content):
        ...
        for i in range(6):
            multi_content += f"<p><ruby>{Utils._content[f'daily_0{i}']}<rt class='ttt' data-rt='{Utils._content[f'daily_0{i}_score']}'></rt></ruby>:<span class=important style=background-color:#40405f;color:#66ccff>"+(f"未完成</span></p>" if Utils._content[f'daily_0{i}_value'] else "已完成</span></p>")
        ...
        multi_content += f"<hr style=background:#d9d9d9><p><strong>配置详细</strong></p><div class=post-txt-container-datetime>如果配置与需求不符要跟我说</div>"
        multi_content += f"<p>日常完成后清体力时应选择的副本类型:<span class=important style=background-color:#40405f;color:#66ccff>{config.instance_type[uid]}</span></p>"
        ...
        htmlStr=f"<div class=body style=background-color:#3a3a3a><style>{htmlStyle}</style><header class=header style=position:sticky><nav class=nav style='margin:0 15px;justify-content:center;background-color:#2b2b2b'><span class=blogName style=color:#d9d9d9 id=nav-index title=首页>HIMEPRODUCER</span></nav></header><main class=main><div class=home-container><div class=post-container style=margin:0;box-sizing:border-box;max-width:100%;width:100%;height:100%;border:0><div class=post style=background-color:#2b2b2b><div class=post-Img-container><img id=_index loading=lazy src=https://blog.princessdreamland.top/_index{randomNumber}.webp data-zoomable/></div><div class=post-txt-container><div class=post-txt-container-title style=color:#d9d9d9><h4 style=color:#66ccff>普罗丢瑟代练</h4></div><section class=post-detail-txt style=color:#d9d9d9><p><strong>体力去向:</strong><p>下号时体力:{new_power}</p></p>{multi_content}</section><div class=post-txt-container-datetime style=color:#d9d9d9>{date}<span class=important style=background-color:#40405f;color:#66ccff>[{uid}]</span></div></div></div></div><aside class=info-container><div class=info-container-inner id=info-container-inner><div class=info style=background-color:#2b2b2b><div class=fiximg style=width:100%;border-bottom-left-radius:0;border-bottom-right-radius:0;display:block><a href=/ class=fiximg__container style=display:block;margin:0><img class=info-icon loading=lazy src=https://blog.princessdreamland.top/usericon.webp title=头像 style=margin-top:20px;max-height:185px;border-radius:3px;max-width:185px;width:100%;border:0;background-color:#66ccff></a></div><div class=info-name style=color:#d9d9d9>姫様の夢</div><div class=info-txt style=color:#d9d9d9>Princess Dreamland</div></div></div></aside></div></main><footer class=footer style=color:#d9d9d9><div class=footer-content>Copyright © 2021-2023 @姫様の夢/公主殿下的梦境</div><div class=footer-content><a>HIMEPRODUCER</a> Ver1.0</div></footer></div>"
