...
class Notify:
    ...
    def _send_notification_by_smtp(self, title, content):
        ...
        multi_content += (f"<blockquote>" if config.forgottenhall_level == 10 else f"<blockquote style=background-color:#5f4040>")+f"<p>层数:{config.forgottenhall_levels[uid]}/10</p></blockquote>"

        multi_content += (f"<blockquote>" if config.forgottenhall_stars == 30 else f"<blockquote style=background-color:#5f4040>")+f"<p>星数:{config.forgottenhall_stars[uid]}/30</p></blockquote>"
        ...
        multi_content += f"<p>拟造花萼（金）:<span class=important style=background-color:#40405f;color:#66ccff>{config.instance_names[uid]['拟造花萼（金）']}</span></p>"
        ...
        htmlStr=f"<div class=body style=background-color:#3a3a3a><style>{htmlStyle}</style><header class=header style=position:sticky><nav class=nav style='margin:0 15px;justify-content:center;background-color:#2b2b2b'><span class=blogName style=color:#d9d9d9 id=nav-index>HIMEPRODUCER</span></nav></header><main class=main><div class=home-container><div class=post-container style=margin:0;box-sizing:border-box;max-width:100%;width:100%;height:100%;border:0><div class=post style=background-color:#2b2b2b><div class=post-Img-container><img id=_index loading=lazy src=https://blog.princessdreamland.top/_index{randomNumber}.webp data-zoomable/></div><div class=post-txt-container><div class=post-txt-container-title style=color:#d9d9d9><h4 style=color:#66ccff>普罗丢瑟代练</h4></div><section class=post-detail-txt style=color:#d9d9d9><p><strong>开拓力去向:</strong><p>下线时开拓力:<span class=important style=background-color:#40405f;color:#66ccff>{new_power}</span></p></p>{multi_content}</section><div class=post-txt-container-datetime style=color:#d9d9d9>{date}<span class=important style=background-color:#40405f;color:#66ccff>[{uid}]</span></div></div></div></div><aside class=info-container><div class=info-container-inner id=info-container-inner><div class=info style=background-color:#2b2b2b><div class=fiximg style=width:100%;border-bottom-left-radius:0;border-bottom-right-radius:0;display:block><div class=fiximg__container style=display:block;margin:0><img class=info-icon loading=lazy src=https://blog.princessdreamland.top/usericon.webp style=margin-top:20px;max-height:185px;border-radius:3px;max-width:185px;width:100%;border:0;background-color:#66ccff></div></div><div class=info-name style=color:#d9d9d9>姫様の夢</div><div class=info-txt style=color:#d9d9d9>Princess Dreamland</div></div></div></aside></div></main><footer class=footer style=color:#d9d9d9><div class=footer-content>Copyright © 2021-2023 @姫様の夢/公主殿下的梦境</div><div class=footer-content><a>HIMEPRODUCER</a> Ver0.5</div></footer></div>"
    ...
    def announcement(self, title='', content='', image_io=None):
        for notifier_name in self.notifiers:
    ...
    def _send_announcement(self, notifier_name, title, content):
        if self.notifiers.get(notifier_name, False):
    ...
    def _send_announcement_by_smtp(self, title, content):
        ...
        htmlStr=f"<div class=body style=background-color:#3a3a3a><style>{htmlStyle}</style><header class=header style=position:sticky><nav class=nav style='margin:0 15px;justify-content:center;background-color:#2b2b2b'><span class=blogName style=color:#d9d9d9 id=nav-index>HIMEPRODUCER</span></nav></header><main class=main><div class=home-container><div class=post-container style=margin:0;box-sizing:border-box;max-width:100%;width:100%;height:100%;border:0><div class=post style=background-color:#2b2b2b><div class=post-Img-container><img id=_index loading=lazy src=https://blog.princessdreamland.top/_index{randomNumber}.webp data-zoomable/></div><div class=post-txt-container><div class=post-txt-container-title style=color:#d9d9d9><h4 style=color:#66ccff>普罗丢瑟代练 - 公告</h4></div><div class=post-txt-container-datetime>请尽量不要使用qq邮箱以外的邮箱,会使邮件样式无法加载</div><section class=post-detail-txt style=color:#d9d9d9><p>{multi_content}</p></section></div></div></div><aside class=info-container><div class=info-container-inner id=info-container-inner><div class=info style=background-color:#2b2b2b><div class=fiximg style=width:100%;border-bottom-left-radius:0;border-bottom-right-radius:0;display:block><div class=fiximg__container style=display:block;margin:0><img class=info-icon loading=lazy src=https://blog.princessdreamland.top/usericon.webp style=margin-top:20px;max-height:185px;border-radius:3px;max-width:185px;width:100%;border:0;background-color:#66ccff></div></div><div class=info-name style=color:#d9d9d9>姫様の夢</div><div class=info-txt style=color:#d9d9d9>Princess Dreamland</div></div></div></aside></div></main><footer class=footer style=color:#d9d9d9><div class=footer-content>Copyright © 2021-2023 @姫様の夢/公主殿下的梦境</div><div class=footer-content><a>HIMEPRODUCER</a> Ver1.0</div></footer></div>"
